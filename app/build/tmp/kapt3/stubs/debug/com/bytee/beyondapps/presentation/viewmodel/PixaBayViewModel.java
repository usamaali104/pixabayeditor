...
public final class PixaBayViewModel extends androidx.lifecycle.ViewModel {
    ...
    private kotlinx.coroutines.flow.MutableStateFlow<com.bytee.beyondapps.data.utils.UiState<com.bytee.beyondapps.domain.model.RandomImagesResponse>> randomImagesApiState;
    ...
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.MutableStateFlow<com.bytee.beyondapps.data.utils.UiState<com.bytee.beyondapps.domain.model.RandomImagesResponse>> getRandomImagesApiState() {
        return null;
    }
    
    public final void setRandomImagesApiState(@org.jetbrains.annotations.NotNull()
    kotlinx.coroutines.flow.MutableStateFlow<com.bytee.beyondapps.data.utils.UiState<com.bytee.beyondapps.domain.model.RandomImagesResponse>> p0) {
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.Flow<androidx.paging.PagingData<com.bytee.beyondapps.domain.model.RandomPhotos>> getRandomPhotos() {
        return null;
    }
}